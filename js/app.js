...
// project filter
const getFilter = document.querySelectorAll("#project-filter a");
...
// visible all filter website
const getAllProjectList = document.querySelectorAll(
    ".cases__list .cases__item"
);
const getAllFilterBtn = document.querySelectorAll(".cases__nav .cases__link");

getAllFilterBtn.forEach((btn, index) => {
    btn.onclick = (tag) => {
        hideAll(getAllProjectList);
